...
class Admin
{
    ...
    public function __construct()
    {
        ...
        add_action('carbon_fields_register_fields', array($this, 'register_review_fields'));
    ...
    public function create_post_types()
    {
        ...
        //Taxonomies
        $custom_taxonomy->register('skill', array('commercial_agent'), 'Skill', 'Skills');
        $custom_taxonomy->register('selling_method', array('commercial_agent'), 'Selling Method', 'Selling Method');
        $custom_taxonomy->register('industry', array('commercial_agent'), 'Industry', 'Industries');
        
        $custom_taxonomy->register('sector', array('company',"opportunity"), 'Sector', 'Sectors');
        $custom_taxonomy->register('activity', array('company'), 'Activity', 'Activities');
        $custom_taxonomy->register('company_type', array('company'), 'Company Type', 'Company Types');
        $custom_taxonomy->register('country', array('company',"commercial_agent","opportunity"), 'Country', 'Countries');
        $custom_taxonomy->register('language', array("commercial_agent","opportunity"), 'Language', 'Languages');
        $custom_taxonomy->register('currency', array("opportunity"), 'Currency', 'Currencies');
    }
    ...
    public function register_company_fields()
    {
        ...
        Container::make('post_meta', __('Company Info'))
            ->add_fields(array(
                ...
                ->add_options(array($this,'get_agent_users')),
                ...
                ->add_options(array($this,'get_activities')),
    ...
    public function register_commercial_agent_fields()
    {
        ...
        Container::make('post_meta', __('Agent Info'))
            ...
            ->add_fields(array(
                ...
                ->add_options(array($this,'get_skills')),
                Field::make('select', 'industry', __('Industry'))
                ->add_options(array($this,'get_industries')),
                ...
                Field::make('select', 'selling_methods', __('Selling Method'))
                    ->add_options(array($this,'get_selling_methods')),
    ...
    public function register_deal_fields()
    {
        Container::make('post_meta', __('Deal Conditions'))
            ...
            ->add_fields(array(
                ...
                ->add_options(array($this,'get_commercial_agents')),

                Field::make('select', 'company', __('Company'))
                ->add_options(array($this,'get_companies')),

                Field::make('select', 'opportunity', __('Company'))
                ->add_options(array($this,'get_opportunities')),
