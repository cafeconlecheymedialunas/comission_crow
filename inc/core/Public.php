...
class PublicFront
{
    ...
    public function handle_scripts()
    {
        ...
        // Verifica si es una entrada singular y los comentarios están abiertos.
        ...
        // Encolar Popper.js y Bootstrap.js y sus estilos.
        ...
        // Encolar SweetAlert y sus estilos.
        ...
        // Encolar tema Select2 Bootstrap.
        ...
        // Encolar DataTables y sus estilos.
        wp_enqueue_style('datatablecss', "https://cdn.datatables.net/2.1.2/css/dataTables.dataTables.css", [], "2.1.2", "all");
        wp_enqueue_script('datatablejs', "https://cdn.datatables.net/2.1.2/js/dataTables.js", ["jquery"], "1.19.3", true);

        // Encolar scripts y estilos personalizados.
        ...
        wp_enqueue_script('opportunity', get_template_directory_uri() . '/assets/js/opportunity.js', ['jquery',"datatablejs"], '1.0', true);
