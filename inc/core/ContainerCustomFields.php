...
class ContainerCustomFields
{
    ...
    public function register_commission_request_fields()
    {
        Container::make('post_meta', __('Commission Request Conditions'))
            ...
            ->add_fields([
                ...
                // Campos del cliente
                Field::make('text', 'customer_name', __('Customer Name')),
                Field::make('text', 'customer_company', __('Customer Company')),
                Field::make('text', 'customer_email', __('Customer Email')),
                Field::make('text', 'customer_address', __('Customer Address')),
                Field::make('text', 'customer_phone', __('Customer Phone Number')),
    ...
    public function register_home_fields()
    {
        ...
        Container::make('post_meta', __('Review'))
            ...
            ))->add_tab(__('Benefits'), array(
                Field::make('text', 'benefit_section__company_title', __('Section Title')),
                Field::make('complex', 'company_benefits', __('Company Benefits'))
                    ->add_fields(array(

                        Field::make('rich_text', 'benefit_html', __('Icon')),
                    ))->set_layout('tabbed-horizontal'),
                Field::make('text', 'benefit_section__agent_title', __('Section Title')),
                Field::make('complex', 'agent_benefits', __('Agent Benefits'))
                    ->add_fields(array(
