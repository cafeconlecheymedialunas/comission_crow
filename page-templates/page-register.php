<?php
/**
 * Template Name: Page Register (No Sidebar)
                        ...
                        <div class="col-md-4">
                            <div class="form-wrap">
                                ...
                                <form id="register_form">
                                    ...
                                    <input class="form-field" type="email" id="user_email" name="user_email" placeholder="Email" required>
                                    <input class="form-field" type="password" id="user_pass" name="user_pass" placeholder="Password" required>
                                    <button type="submit">Register</button>
                                </form>
                                <span class="another-pages">Already have an account?<a href="<?php echo home_url("/login");?>">
                                Login</a></span>
                            </div>
                        </div>
                    </div>
