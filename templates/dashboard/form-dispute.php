    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="create-dispute" method="post" action="" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-12">
              <label for="commission_request_id" class="form-label">Commission Request:</label>
          ...
          <input type="hidden" name="security" value="<?php echo wp_create_nonce("create_dispute_nonce"); ?>"/>
          <div class="alert alert-danger general-errors mt-4" role="alert" style="display:none;"></div>
        </form>
      </div>
