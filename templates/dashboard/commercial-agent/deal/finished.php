...
$deals = $commercial_agent->get_deals("finished");

?>
<div class="card mb-4">
	<h2 class="mb-0"><?php echo __("Finished Deals"); ?><a href="<?php echo home_url("/dashboard/commercial_agent/deal/create"); ?>">Add new</a></h2>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
